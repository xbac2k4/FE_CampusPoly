    ...
    <View style={{ flex: 1 }}>
      <ScrollView style={[styles.container, {
        ...
        <View style={{ paddingHorizontal: 24, marginTop: 20 }}>
          ...
          <Text style={[styles.texthp, {
            color: theme ? '#ECEBED' : Colors.background
          }]}><Text style={{ color: color.textBlod }}>Chính sách quyền riêng tư</Text> của chúng tôi giải thích cách chúng tôi thu thập và sử dụng dữ liệu cá nhân của bạn để xác định sẽ hiển thị quảng cáo nào cho bạn, cũng như để cung cấp tất cả các dịch vụ khác được mô tả bên dưới. Bạn cũng có thể chuyển đến trang cài đặt trên Sản phẩm có liên quan của CampusPoly bất cứ lúc nào để xem các lựa chọn mình có về quyền riêng tư đối với cách chúng tôi sử dụng dữ liệu của bạn.</Text>
          {/* Danh sách điều khoản */}
          <Text style={[styles.textHeader, { marginTop: 10, color: '#6ca0b6' }]}>1. Dịch vụ chúng tôi cung cấp </Text>
          <Text style={[styles.texthp, {
            color: theme ? '#ECEBED' : Colors.background
          }]}>Sứ mệnh của chúng tôi là đem đến cho mọi người khả năng xây dựng cộng đồng và đưa thế giới lại gần nhau hơn. Nhằm thúc đẩy sứ mệnh này, chúng tôi cung cấp các Sản phẩm và dịch vụ được mô tả dưới đây cho bạn:</Text>
          <Text style={[styles.texthp, {
            color: theme ? '#ECEBED' : Colors.background
          }]}><Text style={{ fontWeight: 'bold' }}>Mang lại trải nghiệm dành riêng cho bạn:</Text>
          ...
          <Text style={[styles.texthp, {
            color: theme ? '#ECEBED' : Colors.background
          }]}><Text style={{ fontWeight: 'bold' }}>Kết nối bạn với những người và tổ chức mà bạn quan tâm:</Text>
          ...
          <Text style={[styles.texthp, {
            color: theme ? '#ECEBED' : Colors.background
          }]}><Text style={{ fontWeight: 'bold' }}>Hỗ trợ bạn khám phá nội dung, sản phẩm và dịch vụ mà bạn có thể quan tâm:</Text>
          ...
          <Text style={[styles.texthp, {
            color: theme ? '#ECEBED' : Colors.background
          }]}>Tăng cường tính an toàn, bảo mật và toàn vẹn cho các dịch vụ của chúng tôi, chống lại hành vi có hại cũng như bảo vệ cộng đồng người dùng:</Text>
          ...
          <Text style={[styles.texthp, {
            color: theme ? '#ECEBED' : Colors.background
          }]}>Chúng tôi cung cấp các dịch vụ này cho bạn và cộng đồng để thúc đẩy sứ mệnh của mình. Để đổi lại, chúng tôi cần bạn thực hiện các cam kết sau:

          </Text>
          <Text style={[styles.texthp, {
            color: theme ? '#ECEBED' : Colors.background
          }]}>1:Những đối tượng có thể sử dụng CampusPoly Khi mọi người chia sẻ ý kiến và hành động, cộng đồng của chúng ta sẽ trở nên an toàn và có trách nhiệm hơn. Vì lý do đó, bạn:
          ...
          <Text style={[styles.texthp, {
            color: theme ? '#ECEBED' : Colors.background
          }]}>2:Những điều bạn có thể chia sẻ và thực hiện trên CampusPoly Chúng tôi muốn mọi người sử dụng CampusPoly để thể hiện bản thân và chia sẻ nội dung quan trọng, nhưng không phải với cái giá là sự an toàn và vui khỏe của người khác hay tính toàn vẹn của cộng đồng. Do đó, bạn đồng ý không tham gia vào những hành vi được mô tả dưới đây:
          ...
          <Text style={[styles.texthp, {
            marginBottom: 60,
            color: theme ? '#ECEBED' : Colors.background
          }]}>3:Các giới hạn về việc sử dụng tài sản trí tuệ của chúng tôi
